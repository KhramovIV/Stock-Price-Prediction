...
* В результате были подобраны лучшие гиперпараметры для нейросетей
* Была получена метрика RMSE для GRU и LSTM нейросетей.
![res](pic/res.png)

В результате учёт новостного сентимента незначительно улучшает результат


## Приложение 
![res](pic/sample.png)
Поточечный график предсказаний
